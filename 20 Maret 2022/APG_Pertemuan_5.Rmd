...
Interpretasi:
Pada test Multivariate normal Henze-Zirkler menyatakan bahwa data multivariate/bivariate normal. Akan tetapi ketika melihat plot bivariate, sebaran data nya tidak terlihat pola arahnya. Demikian itu bisa disimpulkan belum cukup bukti untuk menyatakan bahwa data effluent setelah transformasi melanggar asumsi distribusi normal
...
```
Interpretasi:
1. Pada CI untuk single contrast yang mewakili efek paritas 
